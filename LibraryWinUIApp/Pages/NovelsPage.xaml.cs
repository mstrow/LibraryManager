...
namespace LibraryWinUIApp
{
    ...
    /// </summary>
    public sealed partial class NovelsPage : Page
    {
        ...
        private async void GetBooksAsync()
        {
            ...
            if (books.Count >= 1)
            {
                ...
                SelectedBook.Book = BookListView.SelectedItem as NovelBookModel;
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _novelClient.DeleteAsync(SelectedBook.Book.ID);
                GetBooksAsync();
            }
        }
        ...
        {
            SelectedBook.Book = ((ListView)sender).SelectedValue as NovelBookModel;
        }
    }
}
